...
const FAQ = [
  ...
  {
    q: 'מה צריך מבחינה טכנית כדי להתחבר למפגש בזום?',
    a: 'מחשב או טאבלט עם מצלמה ומיקרופון, חיבור אינטרנט יציב ואוזניות. לפני המפגש הראשון נעשה בדיקה קצרה יחד כדי לוודא שהכול עובד. אין צורך בשום ידע טכני - לפני כל מפגש נשלח אליכם קישור פשוט, ולוחצים עליו. ואם החיבור נקטע באמצע, מתחברים שוב לאותו קישור וממשיכים מהנקודה שבה עצרנו.',
  },
  {
  ...
  {
    q: 'האם מפגשי הזום מוקלטים, ומי יכול לשמוע מה נאמר בהם?',
    a: 'המפגשים אינם מוקלטים, ומתקיימים בשיחת וידאו פרטית וסגורה. כל מה שנאמר בהם נשמר בסודיות מלאה, בדיוק כמו במפגש בקליניקה בנתיבות. בצד שלכם מספיק חדר שקט עם דלת שנסגרת ואוזניות, וכך גם אחים או בני בית אחרים אינם שומעים את תוכן השיחה. אם בשלב כלשהו תרצו שאשתף גורם נוסף, כמו יועצת בבית הספר, זה נעשה רק בהסכמתכם.',
  },
];
      ...
      <main className="max-w-3xl mx-auto px-6 py-10 md:py-14">
        ...
        <RelatedLinks
          links={[
            ...
            { href: '/blog/lehaskir-layelad-al-tipul', title: 'איך להסביר לילד שהוא הולך לטיפול',       desc: 'מדריך לשיחה לפי גיל - מה לומר ומה לא.' },
