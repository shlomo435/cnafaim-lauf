...
const homeFaq = [
  ...
  },
  {
    ...
    a: 'הגישה הוליסטית ומשלבת כמה כלים: CBT (טיפול קוגניטיבי-התנהגותי), שנתמך במחקר רחב, לצד EMR (עיבוד רגשי בתנועות עיניים), NLP (ניתוב לשוני פיזיולוגי) והוראה מתקנת - כולם מותאמים אישית לצורך הספציפי של כל מטופל.',
  },
  {
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center">
          ...
          <div className="text-center sr sr-d2">
            ...
            <div className="space-y-4 font-light leading-[1.8] text-[1.05rem]" style={{ color: C.textMid }}>
              ...
              <p>
                הגישה הטיפולית הוליסטית משלבת כמה כלים: טיפול קוגניטיבי-התנהגותי (CBT), שנתמך במחקר רחב,
