...
const FAQ = [
  ...
  {
    q: 'מאיזה גיל מתאים טיפול NLP לילדים?',
    a: 'מגיל הגן ומעלה, בהתאמה לגיל ולבשלות הרגשית. עם הקטנים הכלים עוברים דרך משחק, ציור וסיפור, ועם נערות ונשים בוגרות העבודה מילולית ומודעת יותר. מה שקובע הוא הצורך ואופי הילד ולא הגיל בפני עצמו, ובשיחת ההיכרות בודקים אם זו אכן הגישה המתאימה כרגע.',
  },
  {
    q: 'האם תעבדי רק ב-NLP או שתשלבי שיטות נוספות?',
    a: 'כמעט תמיד משלבים. NLP הוא ארגז כלים משלים, ולא טיפול עצמאי בקושי משמעותי: כשילד מגיע עם חרדה שפוגעת בתפקוד, המסגרת היא CBT שיש לו בסיס מחקרי רחב, וכלי NLP נכנסים בתוכה כשהם מוסיפים ערך. בשיחת ההיכרות נחליט יחד מה מתאים, לפי הילד ולפי הקושי - לא לפי שיטה שנקבעה מראש. השוואה מלאה בין השיטות נמצאת במדריך NLP, CBT או EMR שבבלוג.',
  },
  {
    q: 'כמה מפגשים צריך?',
  ...
  {
    q: 'אפשר לקבל טיפול NLP בזום?',
    a: 'כן. העבודה בכלים האלה נשענת על שיחה ועל דמיון מודרך, ולכן היא עוברת טוב גם דרך המסך. המפגשים מתקיימים בקליניקה בנתיבות, ומי שגר רחוק יותר יכול לקיים אותם בזום או לשלב: חלק מהמפגשים בקליניקה וחלק מרחוק. עם ילדים צעירים בודקים תחילה שהתנאים בבית מאפשרים ריכוז ופרטיות.',
  },
];
