...
const FAQ = [
  ...
  {
    q: 'כמה מפגשי CBT צריך לילד?',
    a: 'CBT הוא טיפול קצר מועד יחסית, ובעבודה ממוקדת מדובר לרוב בסדר גודל של שמונה עד שישה-עשר מפגשים. המספר תלוי בסוג הקושי - פחד ממוקד לרוב קצר יותר מחרדה חברתית שנמשכת שנים - ובקצב שבו הילד מצליח לתרגל בין המפגשים. בודקים התקדמות תוך כדי ולא רק בסוף.',
  },
  {
