...
const FAQ = [
  ...
  {
    q: 'האם EMR זה אותו דבר כמו EMDR שקראתי עליו?',
    a: 'לא. שתי הגישות עובדות על עיבוד רגשי בעזרת תנועות עיניים, אך אינן זהות, וחשוב לנו לא לטשטש את ההבדל. בסיס המחקר הרחב וההנחיות הקליניות הבינלאומיות מתייחסים ל-EMDR באופן ספציפי, ואי אפשר להעביר אותם אוטומטית ל-EMR. אם קראתם על EMDR והגעתם לכאן, בשיחת ההיכרות נסביר בדיוק מה נעשה במפגש ומה לא. הרחבה על ההבדל יש במדריך מה זה EMR שבאתר.',
  },
  {
  ...
  {
    q: 'כמה מפגשי EMR צריך?',
    a: 'אין מספר קבוע, אבל EMR עובדת סביב יעד ממוקד: זיכרון או דפוס מסוים. כשמדובר באירוע אחד ומוגדר, לעיתים די בכמה מפגשים. כשיש שכבות שנצברו לאורך שנים, התהליך ארוך יותר. אחרי כל מפגש בודקים אם העוצמה הרגשית סביב אותו זיכרון ירדה, וזה מה שמנחה אם להמשיך באותו כיוון או לשנות אותו. בשיחת ההיכרות אפשר להעריך כיוון ראשוני.',
  },
  {
      ...
      <main className="max-w-3xl mx-auto px-6 py-10 md:py-14">
        ...
        <div className="space-y-6 text-right">
          ...
          <p className="text-[1.1rem] font-light leading-[1.9]" style={{ color: C.textMid }}>
            ...
            רגשי בעזרת תנועות עיניים. הרחבה על ההבדל הזה יש במדריך{' '}
            <Link
        ...
        <RelatedLinks
          links={[
            { href: '/blog/mah-ze-emr',  title: 'מה זה EMR? המדריך המלא להורים', desc: 'מהי EMR, במה היא שונה, ולאילו מצבים היא מתאימה.' },
